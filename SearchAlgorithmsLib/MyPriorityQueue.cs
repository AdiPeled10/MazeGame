...
namespace SearchAlgorithmsLib
{
        ...
        ICollection<KeyValuePair<TPriority, TValue>>, ICollectionDataStructure<KeyValuePair<TPriority, TValue>>
    {
        ...
        public MyPriorityQueue(int capacity, IComparer<TPriority> comparer)
        {
            if (comparer == null)
        ...
        public MyPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data)
        ...
        /// <param name="data">data to be inserted into priority queue</param>
        /// <param name="comparer">priority comparer</param>
        public MyPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data, IComparer<TPriority> comparer)
        {
        ...
        /// </remarks>
        public static MyPriorityQueue<TPriority, TValue> MergeQueues(MyPriorityQueue<TPriority, TValue> pq1, MyPriorityQueue<TPriority, TValue> pq2)
        {
        ...
        /// <returns>resultant priority queue</returns>
        public static MyPriorityQueue<TPriority, TValue> MergeQueues(MyPriorityQueue<TPriority, TValue> pq1, MyPriorityQueue<TPriority, TValue> pq2, IComparer<TPriority> comparer)
        {
            if (pq1 == null || pq2 == null || comparer == null)
                throw new ArgumentNullException();
            // merge data
            MyPriorityQueue<TPriority, TValue> result = new MyPriorityQueue<TPriority, TValue>(pq1.Count + pq2.Count, pq1._comparer);
        ...
        /// <summary>
        /// Searches a value in all values in this queue.
        /// </summary>
        /// <param name="value">The object to locate in the priority queue</param>
        /// <returns>true if the value exists, false otherwise. </returns>
        public bool ContainsValue(TValue value)
        {
            foreach (KeyValuePair<TPriority, TValue> valueWithPriority in this._baseHeap)
            {
                if (valueWithPriority.Value.Equals(value))
                {
                    return true;
                }
            }
        ...
        /// <summary>
        /// Returns a pair in the priority queue that it's value is the given value.
        /// </summary>
        /// <param name="value"> The value that will be searched. </param>
        /// <returns> a pair in the priority queue that it's value is the given value. </returns>
        public KeyValuePair<TPriority, TValue> GetPairFromValue(TValue value)
        {
            foreach (KeyValuePair<TPriority, TValue> valueWithPriority in this._baseHeap)
            {
                if (valueWithPriority.Value.Equals(value))
